from sqlalchemy import Column, Integer, String, Text, DECIMAL, DATE, TIMESTAMP, ForeignKey, BIGINT
...
class ProcessingLog(Base):
    ...
    file_upload_id = Column(Integer, ForeignKey('fileuploads.file_upload_id'), nullable=False)
